            ...
            <div class="row">
                <div class="filter_div controls">
                    <ul>
                        ...
                        <li class="filter" data-filter=".landings">Лендинги</li>
                        <li class="filter" data-filter=".sites">Сайты</li>
                        <li class="filter" data-filter=".shops">Интернет магазины</li>
                    </ul>
                </div>
                <div id="portfolio_grid">
                    ...
                    <div class="mix col-md-3 col-sm-6 col-xs-12 portfolio_item <?php
                        ...
                        <div class="port_item_cont">
                            ...
                            <form class="opn_win <?php $value = get_post_meta( $id, 'p_class', true );
                            echo $value;
                            ?>">
                                <input type="button" value="Открыть проект" onclick="openWin('<?php
                                echo esc_url( get_template_directory_uri() ); ?>/projects/<?php
                                $value = get_post_meta($id, 'f_name', true ); echo $value; ?>/index.html')">
                            </form>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="contact_box">
                        ...
                        <h3>Веб-сайт:</h3>
                        <p><a href="#" target="_blank"><?php $options = get_option('sample_theme_options');
                                echo $options['sitetext']; ?></a></p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <form action="http://formspree.io/pu6kar.ol@gmail.com" class="main_form" novalidate target="_blank" method="post">
